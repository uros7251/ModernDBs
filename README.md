...
You therefore have to implement the B+-Tree primarily in the header `include/moderndbs/btree.h`, so you are able to compute a more convenient node layout at compile-time.
